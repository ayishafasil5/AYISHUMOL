...
r_text[1] = " ᴀᴄʜᴜᴍᴡᴏʟ tholpikkaan ningalkavilla. Jeevitathil ᴀᴄʜᴜᴍᴡᴏʟ tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "ᴀᴄʜᴜᴍᴡᴏʟ says i love you 😘";
r_text[3] = "Heleneyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "ᴀᴄʜᴜᴍᴡᴏʟ - Bot - Miss  ᴀᴄʜᴜᴍᴡᴏʟ\ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per ᴀᴄʜᴜᴍᴡᴏʟ ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than SHIBI SER";
...
r_text[13] = ".song adich thangalude fav song name para bhaagyandel ᴀᴄʜᴜᴍᴡᴏʟ ath download aakki therum";
