...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/XRvTWZn.jpeg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? '💖SHIBI💖' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+917594029466' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'SHIBI' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Achumwol' : process.env.ALL_CAPTION,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/XRvTWZn.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Achumwol' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ Achumwol ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Achumwol' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/XRvTWZn.jpeg' : process.env.ALL_IMG,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'shibi🎗️/💝/✨/📝' : process.env.CMD_LIST,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Note this' : process.env.TAG_HEADER,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '917594029466,0,917594029466,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUPPORT: "917594029466-1635775355",
    SUPPORT2: "7594029466-1617736751",
    SUPPORT3: "7594029466-1621015274"
};
