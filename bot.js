    ...
    conn.on('open', async () => {
        ...
        console.log(
          ...
          if (config.LANG == 'EN' || config.LANG == 'ML') {
                ...
                if (commits.total === 0) {
                    await conn.sendMessage(conn.user.jid, fs.readFileSync("https://i.imgur.com/EC7OcQS.jpeg"), MessageType.image, { caption: `*ʜᴇʏ ʙʀᴏ ᴀᴄʜᴜᴍᴡᴏʟ ʙᴏᴛ ᴡᴏʀᴋɪɴɢ ` + config.WORKTYPE + ` 🥂* \n\n*ᴛʜᴀɴᴋʏᴏᴜ ғᴏʀ ᴜsɪɴɢ ᴀᴄʜᴜᴍᴡᴏʟ ʙᴏᴛ💙* \n\n*ᴘʟᴇᴀsᴇ sᴀᴘᴘᴏʀᴛ ᴍʏ ᴄʜᴀɴɴᴇʟ❤️*`});
                } else {
